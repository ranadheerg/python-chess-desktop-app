...
class ChessWindow:
    ...
    def draw_board(self):
        ...
        for i, row in enumerate(board_state):
            for j, piece in enumerate(row):
                ...
                widget.grid(row=i, column=j, sticky="nsew", padx=1, pady=1)
    ...
    def get_ai_move(self, fen):
        # This is where I (GitHub Copilot) "think" and predict the next move.
        # For now, you can prompt me in the terminal:
